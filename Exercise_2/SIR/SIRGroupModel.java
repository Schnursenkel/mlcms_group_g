...
public class SIRGroupModel extends AbstractGroupModel<SIRGroup> {
	...
	public void update(final double simTimeInSec) {
		// check whether enough time has passed to proceed with the update
		if (simTimeInSec < updateStepCounter){
			return;
		}
		else {
			updateStepCounter += updateStep;
		}
		//LinkedCellsGrid myGrid = topography.getSpatialMap(Pedestrian.class);
		// use myGrid.getObjects(..) in the loop
